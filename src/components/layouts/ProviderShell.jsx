...
const navItems = [
  { name: 'Overview', icon: LayoutDashboard, page: 'ProviderOverview' },
  { name: 'Onboarding', icon: Building2, page: 'ProviderOnboarding' },
  ...
  { name: 'Referrals', icon: GitMerge, page: 'ReferralTracking' },
  { name: 'Analytics', icon: BarChart3, page: 'ProviderAnalytics' },
  { name: 'Settings', icon: Settings, page: 'Settings' },
];

export default function ProviderShell({ children, currentPageName }) {
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <aside className={cn(
        ...
        <div className={cn(
          ...
          <Link to={createPageUrl('ProviderOverview')} className="flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-3 p-1.5 hover:bg-slate-100 rounded-lg transition-colors">
                  ...
                  <div className="text-left hidden xl:block">
                    <p className="text-sm font-medium text-slate-900">{user?.full_name || 'Provider'}</p>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem asChild>
                  <Link to={createPageUrl('ProviderOverview')}>
